...
final class DatabaseProvider extends $FunctionalProvider<N4KanjiDatabase,
    N4KanjiDatabase, N4KanjiDatabase> with $Provider<N4KanjiDatabase> {
  DatabaseProvider._()
      : super(
          from: null,
          argument: null,
  ...
  @$internal
  @override
  $ProviderElement<N4KanjiDatabase> $createElement($ProviderPointer pointer) =>
      $ProviderElement(pointer);

  @override
  N4KanjiDatabase create(Ref ref) {
    return database(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(N4KanjiDatabase value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<N4KanjiDatabase>(value),
    );
  }
}

String _$databaseHash() => r'9cbf5927cf5511a5e3e5d95ce7a339bd9b705722';

@ProviderFor(repository)
final repositoryProvider = RepositoryProvider._();

final class RepositoryProvider extends $FunctionalProvider<N4KanjiRepository,
    N4KanjiRepository, N4KanjiRepository> with $Provider<N4KanjiRepository> {
  ...
  @$internal
  @override
  $ProviderElement<N4KanjiRepository> $createElement(
          $ProviderPointer pointer) =>
      $ProviderElement(pointer);

  @override
  N4KanjiRepository create(Ref ref) {
    return repository(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(N4KanjiRepository value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<N4KanjiRepository>(value),
    );
  }
}

String _$repositoryHash() => r'b60ace7809ad680713a69256c37ce014587dfebf';

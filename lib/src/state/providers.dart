...
import '../data/db/n4kanji_database.dart';
import '../data/repositories/n4kanji_repository.dart';
...
@riverpod
N4KanjiDatabase database(Ref ref) {
  final db = N4KanjiDatabase();
  ref.onDispose(db.close);
  return db;
}

@riverpod
N4KanjiRepository repository(Ref ref) {
  return N4KanjiRepository(ref.watch(databaseProvider));
}
